...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void delete(String name) {
        ...
        db.delete(TABLE_NAME, whereClause, new String[]{name});
    }

    public void update(String oldName, PersonBean personBean) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(KEY_NAME, personBean.getName());
        values.put(KEY_AGE, personBean.getAge());
        String whereClause = KEY_NAME + "=?";
        db.update(TABLE_NAME, values, whereClause, new String[]{oldName});
    }
}
